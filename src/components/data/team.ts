...
export const ACTIVE_MEMBERS: TeamMember[] = [
  ...
  },
  {
    ...
    major: "Mechanical Engineering & Applied Mechanics",
    sentence:
      "“I'm excited to be part of an undergrad-led team creating a uniquely hands-on environment, with the potential to drive truly original research.”",
  ...
  },
  {
    ...
    major: "Mechanical Engineering & Applied Mechanics",
    sentence:
      "“I'm excited to learn more about propulsion and the rocket engine design process.”",
  ...
  },
  {
    ...
    major: "Mechanical Engineering & Applied Mechanics",
    sentence:
      "“I can't wait to learn through experience and action, and apply my skills to this team and this project.”",
  ...
  },
  {
    ...
    major: "Mechanical Engineering & Applied Mechanics",
    sentence:
      "“I'm looking forward to applying my passion for technical design in a hands-on environment alongside such an inspiring team.”",
...
export const PREVIOUS_MEMBERS: TeamMember[] = [
  ...
  },
  {
    ...
    sentence:
      "“I'm looking forward to helping bring attention to our team's work and fostering support for such a promising initiative.”",
